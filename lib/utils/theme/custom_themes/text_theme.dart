...
class TTextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
      ...
      bodyLarge: TextStyle().copyWith(fontSize: 10.0, fontWeight: FontWeight.w400, color: Colors.black),
  ...
  static TextTheme darkTextTheme = TextTheme(
      ...
      bodyLarge: TextStyle().copyWith(fontSize: 10.0, fontWeight: FontWeight.w400, color: Colors.white),
